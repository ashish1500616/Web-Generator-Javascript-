/*function getDatcit() {
 ...
 function getDatcit() {
     ...
     console.log(strTemp);
     $.getJSON('https://api.openweathermap.org/data/2.5/weather?q=' + strTemp + '&appid=869e6fd2f6e579ae650d308cb7f62cb4', function(str) {
         console.log(str);
 ...
 $(document).ready(function() {
     if (navigator.geolocation) {
         navigator.geolocation.getCurrentPosition(function(position) {
             $.getJSON('https://api.openweathermap.org/data/2.5/weather?lat=' + position.coords.latitude + '&lon=' + position.coords.longitude + '&appid=869e6fd2f6e579ae650d308cb7f62cb4', function(str) {
                 /*optional stuff to do after success */
